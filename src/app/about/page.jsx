  ...
  return (
    <div className="p-8 bg-white min-h-full">
      ...
      <div className="mb-8 pb-6 border-b border-gray-200">
        ...
        <p className="text-sm text-gray-400 mt-1">Manage your personal info and profile details</p>
      </div>
      ...
      <div className="max-w-2xl space-y-4">
        ...
        <div className="border border-gray-200 rounded-xl overflow-hidden hover:border-gray-300 transition-colors">
          <div className="px-5 py-3.5 bg-gray-50 border-b border-gray-200 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Upload your profile or avatar photo</p>
            </div>
          </div>
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex-1">
                <div className="border-2 border-dashed border-gray-200 rounded-xl bg-gray-50 hover:border-gray-400 hover:bg-gray-100 transition-all cursor-pointer px-5 py-4 text-center">
                  ...
                  <p className="text-xs text-gray-300 mt-2">PNG, JPG, WebP · max 5MB</p>
                </div>
                <p className="text-xs text-gray-400 mt-2">Recommended: square image, at least 400×400px</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border border-gray-200 rounded-xl overflow-hidden hover:border-gray-300 transition-colors">
          <div className="px-5 py-3.5 bg-gray-50 border-b border-gray-200 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Your display name on the portfolio</p>
            </div>
          </div>
        ...
        <div className="border border-gray-200 rounded-xl overflow-hidden hover:border-gray-300 transition-colors">
          <div className="px-5 py-3.5 bg-gray-50 border-b border-gray-200 flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-gray-800">Developer Role</p>
              <p className="text-xs text-gray-400">Your title shown under your name</p>
            </div>
          </div>
          <div className="p-4 space-y-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {['Frontend Developer', 'Full Stack Developer', 'Backend Developer', 'UI/UX Designer'].map((role) => (
                <button
                  key={role}
        ...
        <div className="border border-gray-200 rounded-xl overflow-hidden hover:border-gray-300 transition-colors">
          <div className="px-5 py-3.5 bg-gray-50 border-b border-gray-200 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">A short bio shown on your portfolio</p>
            </div>
          </div>
          <div className="p-4 space-y-3">
            <textarea
