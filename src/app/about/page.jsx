      ...
      <div className="max-w-2xl space-y-4">
        ...
        <div className="border border-gray-200 rounded-xl overflow-hidden hover:border-gray-300 transition-colors">
          ...
          <div className="p-4 flex flex-col sm:flex-row items-end sm:items-center gap-3">
            ...
            />
            <button className="px-2 sm:px-4 py-1.5 sm:py-2.5 bg-gray-800 text-white text-sm font-medium rounded-lg hover:bg-gray-700 transition-colors shrink-0">
              Save
            </button>
          </div>
        </div>
        ...
        <div className="border border-gray-200 rounded-xl overflow-hidden hover:border-gray-300 transition-colors">
          ...
          <div className="p-4 space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <button className="px-2 sm:px-4 py-1.5 sm:py-2.5 bg-gray-800 text-white text-sm font-medium rounded-lg hover:bg-gray-700 transition-colors">
                Save
              </button>
            </div>
          </div>
