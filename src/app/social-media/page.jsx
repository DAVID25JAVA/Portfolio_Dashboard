  ...
  return (
    <div className="p-8 bg-white min-h-full">
      ...
      <div className="mb-8 pb-6 border-b border-gray-200">
        <h1 className="text-xl font-semibold text-gray-800">Social & Contact Links</h1>
        <p className="text-sm text-gray-400 mt-1">Add your contact details and social profiles</p>
      </div>
        ...
        {fields.map((field) => (
          ...
          >
            ...
            <div className="px-5 py-3.5 bg-gray-50 border-b border-gray-200 flex items-center gap-3">
              <div className={`w-7 h-7 rounded-lg ${field.bg} border ${field.border} flex items-center justify-center ${field.color}`}>
                {field.icon}
              </div>
              <div>
